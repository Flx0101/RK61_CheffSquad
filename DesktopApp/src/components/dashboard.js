    ...
    $(document).ready(function() {
        ...
        document.getElementById('create-room').addEventListener('click', e => {
            ...
            if (roomName && yourName) {
                roomLink = `https://1b434c809cde.ngrok.io/video?room=${ roomName.trim().replace( ' ', '_' ) }_${ Date.now()}`;
                console.log("Host: ");
...
function HostMeetingModal(props){
    function copytoclipboard(){
        var copyTextarea = document.getElementById('copiedtext');
        copyTextarea.focus();
        copyTextarea.select();
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                <InputGroup className="mb-3">
                    <Form.Control id="copiedtext" type="text" placeholder="Readonly input here..." value={roomLink} readOnly />
                    <InputGroup.Append>
